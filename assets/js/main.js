...
if ((cost > 0) && (summ > 0)) {
    ...
    } else if (cost === summ) { // Fixed equality check
...
if (num > 0) {
    ...
    alert('-1');
} else if (num === 0) { // Use strict equality
    alert('0');
}
...
if (login === "Админ") { // Use strict equality
    let password = prompt("Пароль");
    if (password === 'Я главный') { // Use strict equality
        console.log('Здравствуйте!');
    } else if(password === null) { // Use strict equality
        console.log('Отменено');
    } else {
        console.log('Я вас не знаю');
    }
} else if (login === null) { // Use strict equality
    console.log("Отменено");
} else {
    console.log("Я вас не знаю");
}
